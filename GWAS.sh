...
#Following steps are optional, if not specified then they'll be set to default values
...
#only removing_complexes.sh, QC_for_PCA.sh, removing_LD_for_pca.sh, and pca.sh can be commented (or skipped), the other steps are necessary
